...
"""
This file contains code adapted from the RNA 3D Correspondence project:

https://github.com/BGSU-RNA/RNA-3D-correspondence/blob/master/app/ordering_similarity.py

If you use this code or the ordering method in your work, please cite:

Aliyev, D. A., & Zirbel, C. L. (2023).
Seriation using tree-penalized path length.
European Journal of Operational Research, 305(2), 617–629.
https://doi.org/10.1016/j.ejor.2022.06.026
"""
...
def greedyInsertionPathLength(distance, order=[], verbose=False):
    ...
    if len(order) == 0:
        # Python 2/3 compatibility, use a list, not a range
